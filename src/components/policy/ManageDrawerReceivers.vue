...
<template>
  <div class="p-6">
    ...
    <div v-if="addSearchOpen" class="mb-4 p-3 border border-neutral-200 rounded-sm">
      <AppInput v-model="searchQuery" placeholder="Search organizations..." class="mb-2" />
      <div class="space-y-1 max-h-40 overflow-y-auto">
        <button v-for="org in availableOrgs" :key="org.id"
    ...
    <div class="space-y-2">
      <div v-for="receiver in paginated" :key="receiver.id"
  ...
  <ConfirmDialog v-model="confirmOpen" title="Remove Receiver"
    ...
    confirm-label="Remove" confirm-variant="danger" @confirm="confirmDelete" />
