...
import { XCircle, AlertCircle, CheckCircle, Clock } from '@lucide/vue'
...
const chips = computed(() => [
  ...
  { key: 'signed',       label: 'signed',       variant: 'success', icon: CheckCircle },
...
<template>
  <div class="flex items-center gap-1.5 flex-wrap">
    ...
    <button
      class="text-xs text-primary hover:underline font-medium ml-1"
