    ...
    <section>
      ...
      <div class="space-y-2">
        <div v-if="activeVersion"
          class="flex items-center justify-between px-3 py-2.5 border border-neutral-200 rounded-sm">
      ...
      <div class="flex items-center justify-between mb-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex items-center gap-1 text-xs text-neutral-500">
            ...
            <button :disabled="historyPage >= totalHistoryPages" class="p-1 disabled:opacity-40"
              @click="historyPage++">&#8250;</button>
          </div>
        </div>
      </div>
      <div class="space-y-2">
        <div v-for="ver in paginatedHistory" :key="ver.id"
          class="flex items-center justify-between px-3 py-2.5 border border-neutral-100 rounded-sm">
          <div>
        ...
        <p v-if="historyVersions.length === 0" class="text-sm text-neutral-400 text-center py-2">No archived versions.
        </p>
      </div>
    </section>
  </div>
