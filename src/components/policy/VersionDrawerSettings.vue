    ...
    <div class="space-y-5">
      <div class="grid grid-cols-6 gap-4 items-start">
        <div class="col-span-2">
          ...
          <p class="text-xs text-neutral-500">Suppliers must electronically sign this version before it counts as accepted.</p>
        </div>
        <div class="col-span-4">
          <AppToggle :model-value="version?.require_esignature" :disabled="readonly"
      ...
      <div class="grid grid-cols-6 gap-4 items-start">
        <div class="col-span-2">
          ...
          <p class="text-xs text-neutral-500">Display section numbers in the document</p>
        </div>
        <div class="col-span-4">
          <AppToggle :model-value="version?.numbered_sections" :disabled="readonly"
      ...
      <div class="grid grid-cols-6 gap-4 items-start">
        <div class="col-span-2">
          ...
          <p class="text-xs text-neutral-500">Suppliers can upload supporting documents alongside their signature</p>
        </div>
        <div class="col-span-4">
          <AppSelect :model-value="version?.alternative_documentation" :disabled="readonly" :options="[
      ...
      <div class="grid grid-cols-6 gap-4 items-start">
        <div class="col-span-2">
          ...
          <p class="text-xs text-neutral-500">Upload a branded PDF to be attached alongside this version when sent to suppliers.</p>
        </div>
        <div class="col-span-4">
          <div
            class="border-2 border-dashed border-neutral-200 rounded-sm p-6 flex flex-col items-center justify-center gap-2 text-center">
