  ...
  <div class="p-6 space-y-6">
    ...
    <div class="space-y-5">
      <div>
        ...
        <p class="text-xs text-neutral-500 mb-2">Suppliers must electronically sign this version before it counts as
          accepted.</p>
      ...
      <div>
        ...
        <p class="text-xs text-neutral-500 mb-2">Upload a branded PDF to be attached alongside this version when sent to
          suppliers.</p>
        <div
